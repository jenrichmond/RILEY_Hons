...
HA_child_cheek$emo <- fct_relevel(HA_child_cheek$emo, c("happy", "angry"))
...
```{r cache = TRUE}
child_cheek_lm_1 <- lmer(log_modulus ~ emo + bin + emo*bin + (1|pp_no), data = HA_child_cheek, REML = FALSE)
...
```{r}
child_cheek_lm_2 <- lmer(log_modulus ~ emo + bin + emo*bin + (1 + emo|pp_no) , data = HA_child_cheek, REML = FALSE)
```
...
```{r eval = FALSE}
child_cheek_lm_3 <- lmer(log_modulus ~ emo + bin + emo*bin + (1 + emo + bin|pp_no), data = HA_child_cheek, REML = FALSE)
```
...
```{r}
HA_adult_cheek$emo <- fct_relevel(HA_adult_cheek$emo, c("happy", "angry"))
...
```{r}
adult_cheek_lm_1 <- lmer(log_modulus ~ emo + bin + emo*bin + (1|pp_no), data = HA_adult_cheek, REML = FALSE)
